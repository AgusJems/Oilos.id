            ...
            <div className="flex items-center justify-between">
                ...
                <div className="hidden md:flex gap-3">
                    {!user ? (
                        ...
                        <div className="flex flex-col items-center w-full gap-6 xl:flex-row-reverse relative" ref={dropdownRef}>
                            {/* Avatar */}
                            ...
                            {/* Dropdown Logout */}
                            {isOpen && (
                                <div className="absolute right-0 top-19 z-50 w-48 bg-white border border-gray-200 rounded-xl shadow-lg p-2 dark:bg-gray-800 dark:border-gray-700">
                                    <button
                                        onClick={handleLogout}
                                        className="flex items-center gap-2 w-full px-3 py-2 text-sm font-medium ttext-gray-700 rounded-lg group hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300">
                                        <svg
                                            className="w-5 h-5"
                                            fill="none"
                                            stroke="currentColor"
