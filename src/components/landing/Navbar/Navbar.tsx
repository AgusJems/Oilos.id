            ...
            <div className="hidden md:block">
                ...
                <ul className="flex items-center gap-4">
                    ...
                    <li key={id} className="relative group py-6">
                        ...
                        <a
                            href={link}
                            className="text-md font-medium text-black dark:text-white py-2 px-4 rounded-full hover:bg-gradient-to-r hover:from-green-700 hover:to-green-500 hover:text-white duration-300"
                        >
                            {name}
                        </a>
                        ) : (
