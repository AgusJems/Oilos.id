  ...
  return (
    <>
      ...
      <div className="flex justify-end mb-3">
        <Button onClick={openModal} className="px-4 py-2 bg-green-600 text-white rounded hover:bg-green-700">
          Tambah Data
        </Button>
        ...
        <Modal isOpen={isOpen} onClose={closeModal} className="max-w-[700px] p-6 lg:p-10">
          <div className="flex flex-col px-2 overflow-y-auto custom-scrollbar">
            ...
            <div className="flex items-center gap-3 mt-6 modal-footer sm:justify-end">
              ...
              <button onClick={closeModal} type="button" className="btn btn-success btn-update-event flex w-full justify-center rounded-lg bg-brand-500 px-4 py-2.5 text-sm font-medium text-white hover:bg-brand-600 sm:w-auto">
                Simpan
              </button>
            </div>
          </div>
